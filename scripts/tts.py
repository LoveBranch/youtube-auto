...
EDGE_VOICE_MAP: dict[str, dict[str, str]] = {
    ...
    'en': {
        'SunHi':    'en-US-JennyNeural',
        'JiMin':    'en-US-AriaNeural',
        'YuJin':    'en-US-MichelleNeural',
        'SeoHyeon': 'en-US-JaneNeural',
        'InJoon':   'en-US-GuyNeural',
        'GookMin':  'en-US-ChristopherNeural',
        'BongJin':  'en-US-TonyNeural',
        'Hyunsu':   'en-US-DavisNeural',
    },
    'ja': {
        'SunHi':    'ja-JP-NanamiNeural',
        'JiMin':    'ja-JP-AoiNeural',
        'YuJin':    'ja-JP-MayuNeural',
        'SeoHyeon': 'ja-JP-ShioriNeural',
        'InJoon':   'ja-JP-KeitaNeural',
        'GookMin':  'ja-JP-DaichiNeural',
        'BongJin':  'ja-JP-NaokiNeural',
        'Hyunsu':   'ja-JP-NaokiNeural',
    },
}
